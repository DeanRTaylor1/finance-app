      ...
      <div className='h-[95%] w-[95%] flex flex-col gap-4 pt-8 bg-white  rounded-md px-8 py-4 text-xl font-bold'>
        ...
        <div className="w-full flex justify-center items-center">
          <div className="flex justify-center items-center gap-2 border border-black w-fit">
            <div className="font-extralight text-xs flex justify-center items-center pl-2 hover:cursor-pointer" onClick={() => pageHandler('decrease')}><ArrowLeftIcon className="h-6 w-6" /></div>
            <div className="border-l border-r border-black p-2">{page}</div>
            <div className="font-extralight text-xs flex justify-center items-center pr-2 hover:cursor-pointer" onClick={() => pageHandler('increase')}><ArrowRightIcon className="h-6 w-6" /></div>
          </div>
        </div>
